...
class MySQLDB
{
    ...
    */
   function addNewUser($username, $password, $email, $fullname, $ulevel){
      $time = time();
      $q = "INSERT INTO ".TBL_USERS." VALUES ('$username', '$password', '0', $ulevel, '$email', $time,'$fullname',null,null)";
      return mysqli_query($this->connection, $q) or die($mysql_error());
   }
