...
<?php
    ...
    $result_query = $mysqli->query("SELECT id FROM drip_campaign WHERE id = $drip_id LIMIT 1") or die(mysqli_error());
        ...
        <table class="input drip_edit_form">
            ...
            <tr>
                ...
                <td>        
                    ...
                    ?>
                        <li><label><input type="checkbox" value="<?php echo $row['LEAD_TYPE']; ?>" name="lead_type[<?php echo $row['LEAD_TYPE']; ?>]" /><?php echo $row['LEAD_TYPE']; ?></label></li>
                    <?php } ?>
                    </ul>                       
                </td>
            </tr>
